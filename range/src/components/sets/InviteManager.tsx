...
/**
 * Component for the invite manager.
 */
class InviteManager extends React.Component<InviteManagerProps, InviteManagerState> {
  context!: React.ContextType<typeof ApiContext>;

  /**
   * Initializes the component.
   */
  constructor(props: InviteManagerProps) {
    super(props);
  ...
  /**
   * Creates an invite then refreshes the UI.
   */
  createInvite() {
  ...
  /**
   * Revokes the invite with the given ID and then refreshes the UI.
   */
...
InviteManager.contextType = ApiContext;
